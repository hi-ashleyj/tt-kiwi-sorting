...
def selection_sort(array):
    ...
    for i in range(0, length):
        ...
        for j in range(i, length):
            if (array[j] < array[smallestI]):
                smallestI = j
        if (smallestI != i):
            temp = array[smallestI]
            array[smallestI] = array[i]
            array[i] = temp
    return array

def better_selection_sort(array):
    length = len(array)
    for i in range(0, length):
        smallestI = i
        largestI = length - 1 - i
        if (largestI < smallestI):
            break
        ...
        if (smallestI != i):
            ...
            array[smallestI] = array[i]
            array[i] = temp
        if (largestI != length - 1 - i and largestI != i):
            temp = array[largestI]
            array[largestI] = array[length - 1 - i]
...
def merge_sort(array):
    ...
    left_sorted = merge_sort(array[:middle])
    right_sorted = merge_sort(array[middle:])
    
    result = []
    while (len(left_sorted) > 0 and len(right_sorted)):
    ...
    for i in range(0, len(left_sorted)):
        result.append(left_sorted.pop(0))
    for i in range(0, len(right_sorted)):
        result.append(right_sorted.pop(0))

    return result


def test_algorithm(func, data_string):
...
print("BUBBLE SORT (O):     " + str(test_algorithm(better_bubble_sort, lift)))
print("SELECTION SORT:      " + str(test_algorithm(selection_sort, lift)))
print("SELECTION SORT (O):  " + str(test_algorithm(better_selection_sort, lift)))
print("MERGE SORT:          " + str(test_algorithm(merge_sort, ((lift + ",") * 0) + lift)))
